...
const backgroundImages = [
  {
    ...
    url: "https://images.unsplash.com/photo-1587474268324-8e3c4b1b2f5a?ixlib=rb-4.0.3&auto=format&fit=crop&w=1950&q=80",
  },
  {
    id: "bg-new-2",
    title: "الكعبة ليلاً",
    url: "https://images.unsplash.com/photo-1596178065887-119897f93e4f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1950&q=80",
  },
  {
    id: "bg-new-3",
    title: "المسجد النبوي",
    url: "https://images.unsplash.com/photo-1574624816427-c9a631293c3e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1950&q=80",
  },
  {
    id: "bg-new-4",
    title: "المسجد النبوي ليلاً",
    url: "https://images.unsplash.com/photo-1588269369162-4b11c4ef254a?ixlib=rb-4.0.3&auto=format&fit=crop&w=1950&q=80",
  },
];
const frameStyles = [
  { id: "frame-gold", name: "ذهبي", borderColor: "#d4af37" },
  { id: "frame-green", name: "أخضر", borderColor: "#2E4034" },
];
const busImages = {
  normal:
    "https://images.unsplash.com/photo-1574624816427-c9a631293c3e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1950&q=80",
  vip: "https://images.unsplash.com/photo-1596178065887-119897f93e4f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1950&q=80",
};
const allHotels = [
  {
    id: "palestine",
    name: "فندق فلسطين",
    image:
      "https://images.unsplash.com/photo-1554224155-6726b3ff858f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1950&q=80",
    stars: 4,
    price: 280,
    rating: 4.7,
    distance_meters: 750,
    availability: ["makkahOnly", "makkahVIP", "makkahMadinaVisit"],
    persuasive_details: {
      headline: "🕋 خطوات معدودة تفصلك عن ساحة الحرم",
      recommendation:
        "إذا كان همك الأول هو القرب من الحرم والصلاة في أوقاتها بدون عناء، فهذا هو فندقك. حرفياً دقائق معدودة وأنت في ساحة الحرم. نظافته ممتازة وتقييماته من عملائنا هي الأعلى دائماً.",
      location_detail: "شارع إبراهيم الخليل (750م)",
      service_detail: "الأعلى تقييماً للنظافة والخدمة",
    },
    features: [{ icon: "fas fa-walking", text: "750م للحرم" }],
    badge: { text: "الأقرب للحرم", color: "bg-amber-500" },
  },
  {
    id: "zad",
    name: "فندق زاد الرحمة",
    image:
      "https://images.unsplash.com/photo-1566073771259-6a850609994d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1950&q=80",
    stars: 3,
    price: 115,
    rating: 3.8,
    ...
    persuasive_details: {
      headline: "💰 أفضل قيمة مقابل سعر! خيار اقتصادي ومجرب",
      recommendation:
        "هذا هو خيارنا الأول لمن يبحث عن التوفير الذكي. بسعره الممتاز وموقعه بجوار محطة باصات الحرم مباشرة، ستحصل على خدمة نقل مجانية ومستمرة للحرم على مدار الساعة. الفندق نظيف ومجرب.",
      location_detail: "محبس الجن – بجوار محطة باصات",
      service_detail: "خدمة جيدة ونظافة يومية موثوقة",
    },
    features: [
      { icon: "fas fa-bus", text: "باص للحرم" },
      { icon: "fas fa-wifi", text: "واي فاي" },
    ],
    badge: { text: "أفضل قيمة", color: "bg-green-500" },
  },
  {
    id: "holidayinn",
    name: "فندق هوليدي إن العزيزية",
    image:
      "https://images.unsplash.com/photo-1574624816427-c9a631293c3e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1950&q=80",
    stars: 5,
    price: 225,
    ...
    availability: ["makkahOnly", "makkahVIP", "makkahMadinaVisit"],
    persuasive_details: {
      headline: "✨ راحة خمس نجوم بسعر مدروس",
      recommendation:
        "إذا كنت تبحث عن فخامة وخدمة فندقية عالمية بسعر مدروس، فهذا هو اختيارك. هوليدي إن اسم معروف بجودته. يوفر باصات فاخرة ومريحة تعمل على مدار اليوم لتوصيلك للحرم.",
      location_detail: "حي العزيزية – باصات فاخرة للحرم",
      service_detail: "خدمة وتنظيم احترافي من علامة عالمية",
    },
    features: [
      { icon: "fas fa-bus", text: "باص للحرم" },
      { icon: "fas fa-wifi", text: "واي فاي" },
    ...
    badge: { text: "الأكثر طلباً", color: "bg-blue-500" },
  },
  {
    id: "ummakkah",
    name: "فندق أم مكة ميلينيوم",
    image:
      "https://images.unsplash.com/photo-1596178065887-119897f93e4f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1950&q=80",
    stars: 5,
    price: 210,
    rating: 4.3,
    distance_meters: 1800,
    ...
    availability: ["makkahOnly", "makkahVIP", "makkahMadinaVisit"],
    persuasive_details: {
      headline: "💎 إقامة فندقية راقية تحت إدارة ميلينيوم",
      recommendation:
        "تجربة فندقية ممتازة تحت إدارة علامة ميلينيوم العالمية. الفندق يقدم مستوى عالياً من النظافة والخدمة الاحترافية. مع وجود باصات مجدولة ومنظمة، يجمع هذا الفندق بين الإقامة الراقية والسعر التنافسي.",
      location_detail: "شارع إبراهيم الخليل – باصات للحرم",
      service_detail: "خدمة فندقية ممتازة ونظافة عالية",
    },
    features: [
      { icon: "fas fa-bus", text: "باص للحرم" },
      { icon: "fas fa-concierge-bell", text: "خدمة غرف" },
    ],
  },
  {
    id: "razana",
    name: "فندق رزانة الروضة",
    image:
      "https://images.unsplash.com/photo-1596178065887-119897f93e4f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1950&q=80",
    stars: 4,
    price: 160,
    ...
    availability: ["makkahOnly", "makkahVIP", "makkahMadinaVisit"],
    persuasive_details: {
      headline: "⭐ إقامة ممتازة في حي الروضة مع توصيل",
      recommendation:
        "يتميز فندق رزانة الروضة بمستواه الممتاز وخدماته الراقية. مع خدمة التوصيل المريحة للحرم، يعتبر خياراً رائعاً لمن يبحث عن إقامة عالية الجودة بسعر مدروس.",
      location_detail: "حي الروضة (1500م) مع توصيل",
      service_detail: "مستوى خدمة ممتاز ونظافة عالية",
    },
    features: [{ icon: "fas fa-bus", text: "باص للحرم" }],
  },
  {
    id: "parkroyal",
    ...
    availability: ["makkahOnly", "makkahVIP", "makkahMadinaVisit"],
    persuasive_details: {
      headline: "🏨 إقامة عصرية على بعد خطوات من الحرم",
      recommendation:
        "يتميز فندق بارك رويال بموقعه المميز قرب الحرم المكي وتصميمه العصري. يوفر غرفاً مريحة مع خدمات عالية الجودة، مما يجعله خياراً مثالياً للراغبين في تجربة عمرة مريحة وعصرية.",
      location_detail: "شارع إبراهيم الخليل (900م)",
      service_detail: "تصميم حديث وخدمة استقبال ممتازة",
    },
    features: [{ icon: "fas fa-wifi", text: "واي فاي" }],
    badge: { text: "تصميم عصري", color: "bg-purple-500" },
  },
  {
    id: "qasr",
    name: "فندق قصر رزق",
    ...
    availability: ["makkahOnly", "makkahVIP", "makkahMadinaVisit"],
    persuasive_details: {
      headline: "🌟 إقامة هادئة ومريحة مع باص خاص",
      recommendation:
        "هذا الفندق يجمع بين الهدوء والراحة. يميزه وجود باص خاص من أمام الباب يوصلك للحرم ويرجعك، وهذا يوفر عليك الكثير من الجهد. معروف بنظافته وحسن تعامل طاقمه.",
      location_detail: "شارع إبراهيم الخليل (1500م)",
      service_detail: "تميز بالهدوء وحسن تعامل طاقمه",
    },
    features: [
      { icon: "fas fa-bus", text: "باص للحرم" },
      { icon: "fas fa-wifi", text: "واي فاي" },
    ],
    badge: { text: "إقامة هادئة", color: "bg-gray-500" },
  },
  {
    id: "fouco",
    name: "فندق فوكو IHG",
    ...
    availability: ["makkahOnly", "makkahVIP", "makkahMadinaVisit"],
    persuasive_details: {
      headline: "🌟 تجربة إقامة راقية في فندق بإدارة عالمية",
      recommendation: "تجربة إقامة راقية في فندق بإدارة عالمية",
      location_detail: "شارع إبراهيم الخليل – قريب من محطة باصات الحرم",
      service_detail: "فخامة عالمية وخدمة استثنائية",
    },
    features: [
      { icon: "fas fa-bus", text: "باص للحرم" },
      { icon: "fas fa-wifi", text: "واي فاي" },
    ],
    badge: { text: "فخامة عالمية", color: "bg-red-500" },
  },
];
const motivationalPhrases = [
  "نسعد بخدمتكم ونتمنى لكم عمرة مقبولة.",
  "راحتكم غايتنا... رحلة إيمانية لا تُنسى.",
];
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const showAlertModal = (
    ...
    modal.querySelector("#alertIcon").className =
      `fas ${iconClass} text-green-600 text-3xl`;
  ...
  umrahForm.addEventListener("submit", (e) => {
    ...
    lastCalculatedTripDetails = {
      ...
      directionText:
        tripDirectionSelect.options[tripDirectionSelect.selectedIndex].text,
      tripDuration: calculateTripDays(
    ...
    displayOffers(
      allHotels.filter((h) =>
        h.availability.includes(lastCalculatedTripDetails.tripType),
      ),
      lastCalculatedTripDetails,
    );
  });
  ...
  const displayOffers = (hotels, tripDetails) => {
    ...
    const offers = hotels
      .map((hotel) => {
        ...
        if (tripDetails.isSingle) {
          ...
          busCost =
            calculateBusPrice(tripDetails.tripDuration, tripDetails.isVip) *
            tripDetails.numSeats;
      ...
      .sort((a, b) => {
        ...
        if (currentSortCriteria === "distance")
    ...
    offers.forEach((offer) => {
      const card = document
        .getElementById("offer-card-template")
        .content.cloneNode(true);
      card.querySelector(".hotel-name").textContent = offer.name;
      card.querySelector(".hotel-rating span").textContent = offer.rating;
      card.querySelector(".hotel-stars").textContent = offer.stars
        ? "⭐".repeat(offer.stars)
        : "سكن مشترك";
      card.querySelector(".hotel-headline").textContent =
        offer.persuasive_details.headline;
      card.querySelector(".total-cost").textContent =
        `${offer.totalCost.toLocaleString()} ﷼`;
      const featuresContainer = card.querySelector(".hotel-features");
      if (offer.features)
        offer.features.forEach(
          (f) =>
            (featuresContainer.innerHTML += `<span class="flex items-center"><i class="${f.icon} ml-1"></i> ${f.text}</span>`),
        );
      if (offer.badge) {
      ...
      card.querySelector(".expert-tip").textContent =
        `💡 نصيحة الخبير: ${offer.persuasive_details.service_detail}`;
      const offerText = getOfferText(offer, tripDetails, offer.totalCost);
      card.querySelector(".copy-btn").onclick = (e) =>
        copyToClipboard(e.currentTarget, offerText);
      card.querySelector(".image-btn").onclick = () =>
        generateOfferImage(
          offer.id,
          offer.totalCost,
          offer.hotelCost,
      ...
      card.querySelector(".whatsapp-btn").href =
        `https://wa.me/?text=${encodeURIComponent(offerText)}`;
  ...
  const getOfferText = (hotel, tripDetails, totalCost) => {
    const accommodation = tripDetails.isSingle
      ? `(سكن مشترك)`
      : `(${"⭐".repeat(hotel.stars)})`;
    return (
  ...
  const generateOfferImage = async (
    ...
    const imageUrl = await generateOfferImageForChat(
      hotelId,
      totalPrice,
      hotelCost,
      busCost,
  ...
  const generateOfferImageForChat = async (
    hotelId,
    totalPrice,
    hotelCost,
    busCost,
    ...
    if (!lastCalculatedTripDetails) {
      showAlertModal("يرجى حساب رحلة أولاً.");
      return null;
    }
    try {
      ...
      await Promise.all([
        preloadImage(randomBg.url),
        preloadImage(portalInfo.logo),
        preloadImage(
          busImages[lastCalculatedTripDetails.isVip ? "vip" : "normal"],
        ),
        preloadImage(hotelData.image),
      ]);
      populateTemplate(
        hotelData,
        totalPrice,
        hotelCost,
        busCost,
        randomFrame.borderColor,
        randomBg.url,
      );
      const canvas = await html2canvas(
        document.getElementById("offer-image-template"),
      ...
      showAlertModal(
        `فشل إنشاء الصورة. ${error.message}`,
        "خطأ",
        "fa-times-circle",
      );
      return null;
  ...
  const populateTemplate = (
    ...
    document.getElementById("template-agency-name").textContent =
      portalInfo.fullName;
    document.getElementById("template-client-name").textContent = clientName
      ? `عرض خاص لـ: ${clientName}`
      : `عرض خاص لضيوف الرحمن`;
    document.getElementById("template-hotel-image").src =
      hotelData.image ||
      `https://placehold.co/240x240/2E4034/FFFFFF?text=${encodeURIComponent(hotelData.name)}`;
    document.getElementById("template-bus-image").src =
      busImages[isVip ? "vip" : "normal"];
    document.getElementById("template-hotel-name").textContent = hotelData.name;
    document.getElementById("template-stars").textContent = isSingle
      ? "سكن مشترك"
      : "⭐".repeat(hotelData.stars);
    document.getElementById("template-recommendation").textContent =
      hotelData.persuasive_details.recommendation;
    document
      .getElementById("template-dates")
      .querySelector("span").textContent =
      `${tripDuration} أيام / ${nights} ليالٍ`;
    document
      .getElementById("template-booking-details")
      .querySelector("span").textContent = isSingle
      ? `${numSeats} سرير`
      : `${numSeats} أشخاص - ${numRooms} غرفة`;
    document
      .getElementById("template-bus-details")
      .querySelector("span").textContent = isVip
      ? "باص فاخر VIP"
      : "باص سياحي حديث";
    document
      .getElementById("template-location-details")
      .querySelector("span").textContent = `من ${departureCity}`;
    document.getElementById("price-value").textContent =
      totalPrice.toLocaleString();
    document.getElementById("price-title").textContent = isSingle
      ? "السعر للشخص"
      : "السعر الإجمالي";
    document.getElementById("template-motivational-footer").textContent =
      motivationalPhrases[
    ...
    new QRCode(qrContainer, {
      text: `https://wa.me/${portalInfo.whatsapp}`,
      width: 90,
      height: 90,
      colorDark: "#111827",
      colorLight: "#ffffff",
  ...
  sortingControls.onclick = (e) => {
    ...
    document
      ...
      .forEach((btn) =>
        btn.classList.remove("active", "bg-secondary-green", "text-white"),
      );
  ...
  const addMessage = (text, sender, options = []) => {
    ...
    if (options.length > 0) {
      options.forEach((opt) => {
        ...
        button.onclick = () =>
          handleChatOption(opt.action, opt.value, opt.text);
  ...
  const initiateChat = () => {
    ...
    const welcomeMessage =
      "مرحباً، أنا مساعدك الذكي. يمكنك أن تسألني عن أي شيء يخص العمرة، أو تصف لي الرحلة التي تحلم بها.";
  ...
  const handleChatOption = (action, value, text) => {
    ...
    if (action === "start_umrah_trip") {
      ...
      addMessage(
        "على الرحب والسعة. لنبدأ، ما هي وجهتك المفضلة؟",
        "bot",
        tripOptions,
      );
  ...
  const handleTripPlanningInput = (input, type = null) => {
    switch (chatState.currentStep) {
      case "waiting_for_destination":
        chatState.tripDetails.destination =
          type === "destination" ? input : null;
        if (!chatState.tripDetails.destination) {
          // Basic parsing if user types
          const foundOption = Array.from(tripDirectionSelect.options).find(
            (opt) => opt.textContent.includes(input),
          );
          chatState.tripDetails.destination = foundOption
            ? foundOption.value
            : "makkahOnly";
        }
  ...
  const getAiChatResponse = async (userInput) => {
    ...
    setTimeout(() => {
      ...
      if (chatState.currentStep === "processing") {
        addMessage(
          "بناءً على التفاصيل التي قدمتها، أقترح عليك الخيارات التالية:",
          "bot",
        );
        ...
        addMessage("هل ترغب في الحصول على صورة عرض لأحد هذه الفنادق؟", "bot", [
          {
            text: "نعم، فندق فلسطين",
            action: "generate_image",
            value: "palestine",
          },
          {
            text: "نعم، فندق زاد الرحمة",
            action: "generate_image",
            value: "zad",
          },
